        ...
        <div class="container" id="product-list-1">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mt-5">
                    ...
                    <li class="breadcrumb-item"><a href="../product-all">Products</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Hiasan</li>
                </ol>
            </nav>
            <!-- end of divider -->
        </div>
...
$sql = mysqli_query($koneksi, "SELECT * FROM product WHERE kategori_product='hiasan'");
